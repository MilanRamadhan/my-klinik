...
export default function BpjsBanner() {
  return (
    <div className="my-10 rounded-2xl bg-white px-20 py-0 h-25 w-170 shadow-[3px_5px_5px_rgba(0,0,0,0.15)] ring-1 ring-black/5 flex items-center justify-between gap-4">
